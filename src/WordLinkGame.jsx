...
export default function WordLinkGame() {
    ...
    return (
      ...
      >
        {chars.map((c, idx) => {
          ...
          const base =
            "w-8 h-10 mr-1 grid place-items-center rounded-md border text-base font-mono sm:w-10 sm:h-12 sm:mr-2 sm:text-lg";
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6">
      <div className="w-full max-w-2xl">
        <div className="bg-white/90 backdrop-blur rounded-2xl shadow-xl p-4 sm:p-6 border border-slate-200 max-h-[90vh] sm:max-h-none overflow-auto">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs sm:text-sm">
                ...
                <span className="hidden sm:inline">
                  {" "}
                  Example: <span className="italic">coffee → table → tennis → racket</span>.
                </span>
              </p>
            </div>
          ...
          {/* Builder */}
          {builderOpen && (
            <section className="mt-4 grid gap-3 border border-slate-200 rounded-xl p-4 bg-slate-50">
                ...
                return (
                  ...
                  >
                      ...
                      {isActive && (
                        <>
                          <input
                            ...
                            aria-hidden
                          />
                          <span className="sm:hidden text-[11px] text-slate-500 ml-1">
                            Press Return
                          </span>
                        </>
                      )}
                    ...
                    <div className="text-sm text-slate-600">
                      Guesses: <span className="font-semibold">{attempts[i] || 0}</span>
                    </div>
                  </li>
                );
              })}
